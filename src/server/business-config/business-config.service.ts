          ...
          if (needsReferralUpdate || needsGratitudeUpdate) {
            ...
            await (this.prisma as any).businessConfiguration.update({
              ...
              data: {
                ...
                payoutConfig: latestConfig.payoutConfig || {
                  cycle1: { startDay: 5, cutoffDay: 19, payoutDay: 21 },
                  cycle2: { startDay: 20, cutoffDay: 4, payoutDay: 6 },
                },
                prorationConfig: latestConfig.prorationConfig || {
                  status: 'PENDING_CLIENT_CONFIRMATION',
                  basis: 'CALENDAR_DAYS',
                },
                systemDefaults: {
            ...
            console.log(`Updated BusinessConfiguration v${latestConfig.version} to 12 fixed referral levels and Product 360 parameters.`);
          }
        }
      }
    } catch (err: any) {
